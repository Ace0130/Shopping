...
const NotFound = () => {
  ...
  return (
    <div
      className="h-screen bg-gradient-to-tr 
    from-orange-500 to-violet-500 flex flex-col items-center"
    >
      <h1
        className="text-9xl font-bold text-lime-300 
        align-top py-5 tracking-wider"
      >
        404
      </h1>
      <h2
        id="h2"
        className="text-7xl font-bold text-teal-300 
      ...
      />
      <button
        className="py-2 px-4 mt-20 font-semibold rounded-lg 
