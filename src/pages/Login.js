      ...
      <div className="container px-8 py-12 bg-sky-300 rounded-lg p-5 m-auto">
        <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
          <header className="sm:w-10/12 md:w-6/12 lg:w-4/12 mb-10 md:mb-0">
            <img
              className="min-w-full min-h-full mb-5"
          ...
          <div className="flex-wrap md:w-8/12 lg:w-5/12 lg:ml-20">
            <form>
              <div>
                <label className="block mb-1 text-indigo-500" for="emailAdress">
                  Email adress
                </label>
                <input
                  alt=""
              ...
              <div>
                <label className="block mb-1 text-indigo-500" for="password">
                  Password
                </label>
                <input
                  alt=""
              ...
              <footer>
                <a
                  className="text-indigo-700 hover:text-pink-700 text-sm float-left m-2"
                  href="#"
                >
                  Forgot Password?
                </a>
                <a
                  className="text-indigo-700 hover:text-pink-700 text-sm float-right m-2"
                  href="#"
                >
                  Create Account
                </a>
